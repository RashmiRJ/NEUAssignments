   ...
   private boolean passwordPatternCorrect() {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (!usernamePatternCorrect()) {
            txtUser.setBorder(new LineBorder(Color.RED));
            jLabel1.setForeground(Color.RED);
            JOptionPane.showMessageDialog(null, "User name should be the form of <Abc1_Abc1@abc.com>");
            return;
        }
        ...
        if (!passwordPatternCorrect()) {
            txtPword.setBorder(new LineBorder(Color.RED));
            jLabel2.setForeground(Color.RED);
            JOptionPane.showMessageDialog(null, "Invalid password format, please correct and try again");
            return;
        }
        ...
        if(!(p1.equals(p2))) {
            ...
            txtRePword.setBorder(new LineBorder(Color.RED));
            jLabel3.setForeground(Color.RED);
            JOptionPane.showMessageDialog(null, "Passwords do not match, please correct and try again");
            return;
        }
        ...
        if (!radioCustomer.isSelected() && !radioSupplier.isSelected()) {
            JOptionPane.showMessageDialog(null, "Please select whether you are a Customer or a Supplier");
            return;
        }
        ...
        if (radioSupplier.isSelected()) {
            ...
            JOptionPane.showMessageDialog(null, "Created Supplier successfully");
            CardLayout card = (CardLayout) this.panelRight.getLayout();
            this.panelRight.remove(this);
            Component[] cps = this.panelRight.getComponents();
            for (Component cp : cps) {
                if (cp instanceof AdminMainScreen) {
                    AdminMainScreen ams = (AdminMainScreen) cp;
                    ams.populate();
                }
            }
